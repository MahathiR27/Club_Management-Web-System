...
const pdf_storage = multer.diskStorage({ // Store korar jonno secondary storage e jayga set kore
  destination: (req, file, cb) => cb(null, './uploads'),
  filename: (req, file, cb) => {cb(null, `${Date.now()}_${file.originalname}`);},
});

const pdf_upload = multer({ // File jeita upload korse oita jodi pdf hoy taile strorage e add kore dibe
  storage: pdf_storage,
...
app.post('/upload_pdf', pdf_upload.single('pdf'), (req, res) => {
